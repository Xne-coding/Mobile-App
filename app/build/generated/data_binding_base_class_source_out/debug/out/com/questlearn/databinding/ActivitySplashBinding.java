...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull FrameLayout rootView, @NonNull View dot1,
      @NonNull View dot2, @NonNull View dot3, @NonNull LinearLayout loaderContainer,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((FrameLayout) rootView, dot1, dot2, dot3, loaderContainer,
          splashContent);
    }
