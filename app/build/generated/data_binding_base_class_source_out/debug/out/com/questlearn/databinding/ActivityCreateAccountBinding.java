...
public final class ActivityCreateAccountBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout createAccountRoot;
  ...
  private ActivityCreateAccountBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull Button btnCreateAccount, @NonNull TextInputLayout confirmLayout,
      @NonNull LinearLayout createAccountRoot, @NonNull TextInputLayout emailLayout,
      ...
      @NonNull TextInputLayout nameLayout, @NonNull TextInputLayout passwordLayout) {
    this.rootView = rootView;
    this.btnBack = btnBack;
    this.btnCreateAccount = btnCreateAccount;
    this.confirmLayout = confirmLayout;
    this.createAccountRoot = createAccountRoot;
  ...
  public static ActivityCreateAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout createAccountRoot = (LinearLayout) rootView;
      ...
      return new ActivityCreateAccountBinding((LinearLayout) rootView, btnBack, btnCreateAccount,
          confirmLayout, createAccountRoot, emailLayout, etConfirmPassword, etEmail, etName,
          etPassword, nameLayout, passwordLayout);
    }
